...
helm-release:
	...
	gh release upload $(GITHUB_TAG) deployment/chart/whereabouts.tgz 
	...
	helm repo index --url https://github.com/$(GITHUB_REPO_OWNER)/whereabouts/releases/download/$(GITHUB_TAG)/ deployment/chart/
